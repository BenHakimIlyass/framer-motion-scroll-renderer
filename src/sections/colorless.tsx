...
export default function Colorless({ yPosition, min }: Props) {
  ...
  const backgroundStyle = {
    initial: { transform: `translate3d(200%,${yPosition}px,0) scale(0.8)` },
    visible: { transform: `translate3d(-20%,${yPosition}px,0) scale(0.9)` },
    active: { transform: `translate3d(-20%,${yPosition}px,0) scale(1)` }
  };
...
`;
const url =
  "https://images.unsplash.com/photo-1515375380578-a0587184cedd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1976&q=80";
